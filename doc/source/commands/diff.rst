...
- `<reference tractogram> TEXT:FILE REQUIRED`
  Reference tractogram (.vtk, .tck)
...
.. raw:: html
   ...
   <table style="width: 100%; border-collapse: collapse;">
       ...
       <tr>
           <td style="padding: 8px; font-weight: 500;">-d, --out_diff TEXT</td>
           <td style="padding: 8px;">Output streamlines of input tractogram that does not exist in the reference (.vtk, .tck).</td>
       </tr>
       <tr style="background-color: #f2f2f2;">
           <td style="padding: 8px; font-weight: 500;">-s, --out_same TEXT</td>
           <td style="padding: 8px;">Output streamlines of input tractogram that exists in the reference (.vtk, .tck).</td>
       </tr>
   </table>

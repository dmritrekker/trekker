...
call test_win_disp_file_info.bat "%track2img_output%"
...
call test_win_disp_file_info.bat "%track2surf_output%"
...
call test_win_disp_file_info.bat "%fiber_tracking_output%"

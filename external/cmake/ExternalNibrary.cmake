...
SET(NIBRARY_MIN_VERSION "0.5.0" CACHE STRING "Minimum nibrary version") 

include("${CMAKE_CURRENT_LIST_DIR}/utils.cmake")

if (CMAKE_SYSTEM_NAME STREQUAL "Windows")
    if (BUILD_SHARED_LIBS)
        set(NIBRARY_LIBRARIES Nibrary geogram zlib dcm2niix++ trx CACHE INTERNAL "Nibrary libraries to link against")
    else()
        set(NIBRARY_LIBRARIES Nibrary geogram zlibstatic dcm2niix++ trx CACHE INTERNAL "Nibrary libraries to link against")
    endif()
else()
        set(NIBRARY_LIBRARIES Nibrary geogram z dcm2niix++ trx CACHE INTERNAL "Nibrary libraries to link against")
endif()

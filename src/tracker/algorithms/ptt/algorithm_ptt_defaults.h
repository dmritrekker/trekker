...
#define DEFAULT_PTT_STEPSIZE_IN_PIXELDIM                        0.02
...
#define DEFAULT_PTT_TRIESPERREJECTIONSAMPLING                  10000

#define DEFAULT_PTT_INIT_POSTESTITCOUNT_INITIAL_CONDITION 		  20
#define DEFAULT_PTT_PROP_POSTESTITCOUNT_INITIAL_CONDITION 		  20
#define DEFAULT_PTT_INIT_MAXPOSTESTIT 							1000
#define DEFAULT_PTT_INIT_MINPOSTESTIT 	 		   				   1
